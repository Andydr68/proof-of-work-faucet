...
const MIN_LEARNED_CLAIMS: u64 = 8;
const FULL_CONFIDENCE_CLAIMS: u64 = 100;
const MIN_LEARNED_RATIO: f64 = 0.25;
const MAX_LEARNED_RATIO: f64 = 4.0;
const MAX_RECENT_SAMPLES: usize = 75;
const EXPLORATION_FULLY_KNOWN_CLAIMS: u64 = 100;
const MAX_EXPLORATION_BONUS: f64 = 0.15;
